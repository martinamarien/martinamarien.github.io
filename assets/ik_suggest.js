(function($, window, document, undefined) {
  var pluginName = 'ik_suggest',
    defaults = {
      instructions:
        'As you start typing the application might suggest words that are similar. Use up and down arrow keys to select a suggested string.',
      minLength: 2,
      maxResults: 10,
      source: []
    };
  ...
  Plugin.prototype.getSuggestions = function(arr, str) {
    ...
    if (r.length > 1) {
      this.notify.text(
        'Suggestions are available for this field. Use up and down arrows to select a suggestion and enter key to use it.'
      );
    }
